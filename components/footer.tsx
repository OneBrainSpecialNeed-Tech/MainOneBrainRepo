    ...
    <footer className="bg-muted/50 py-12 px-4 mt-16">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <p className="text-muted-foreground mb-6 max-w-xl mx-auto leading-relaxed">
          פרויקט מוח אחד הוא פרויקט סמינריון המחבר בין תלמידי מגמת טכנולוגיה לתלמידי חינוך מיוחד.
          התלמידים עבדו יחד כדי ליצור משחקים חינוכיים - תלמידי החינוך המיוחד תכננו את המשחקים
        ...
        <p className="text-sm text-muted-foreground flex items-center justify-center gap-2">
          ...
          <span>על ידי תלמידי הסמינריון</span>
        </p>
